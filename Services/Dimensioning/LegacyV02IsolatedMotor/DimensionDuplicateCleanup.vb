...
''' <summary>
''' Elimina cotas duplicadas tras el barrido: mismos keypoints y, por vista, mismo valor + orientación (H/V).
''' </summary>
Friend NotInheritable Class DimensionDuplicateCleanup
    ...
    ''' <summary>Una cota lineal por valor nominal y orientación (H/V) dentro de cada vista.</summary>
