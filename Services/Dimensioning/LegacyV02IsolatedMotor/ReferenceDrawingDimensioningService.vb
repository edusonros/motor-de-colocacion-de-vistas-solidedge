...
Friend NotInheritable Class ReferenceDrawingDimensioningService
    ...
    Private Shared Sub RefcheckAuditSinglePartsList(draftDoc As DraftDocument, norm As DimensioningNormConfig, log As DimensionLogger)
        ...
        ' Motor LegacyV02 aislado: PartsListSuperiorService del proyecto principal espera DimensioningNormConfig del raíz; aquí norm es LegacyV02Dimensioning.DimensioningNormConfig.
        log?.LogLine("[REFCHECK][SKIP] partslist_structure_refcheck (motor LegacyV02 aislado; no se invoca PartsListSuperiorService del arbol principal)")
    End Sub
